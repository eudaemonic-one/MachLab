...
def get_model_info(context, username, model_name):
    # User informtion #
...
def models(request, username, model_name):
    ...
    get_model_info(context, username, model_name)
            ...
            if form.is_valid():
                ...
                if model is not None:
                    ...
                    if new_model is not None:
                        ...
                        model.save()
                    get_model_info(context, username, new_model_name)
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                if model is not None:
                    ...
                    new_model.save()
                    get_model_info(context, request.user.username, new_model_name)
                    return render(request, 'files.html', context)
        else:
            form = ModelSettingsForm()
            context['form'] = form
